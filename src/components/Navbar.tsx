...
export const Navbar = () => {
  ...
  return (
    <nav className="flex justify-between items-center py-6 px-12 fixed w-full top-0 z-50 backdrop-blur-sm bg-alabaster/80 dark:bg-charcoal/80 transition-colors duration-300">
